...
<div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('kabel.store') }}" method="POST" onsubmit="return validasiForm()">
                @csrf

                <div class="row mb-3">
                    <label for="MerkKabel" class="col-sm-2 col-form-label">Merk Kabel</label>
                    <div class="col-sm-10">
                        <input type="text" name="merkkabel" id="merkkabel" maxlength="20" value="{{ old('merkkabel') }}" class="form-control" >
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="stockkabel" id="stockkabel" min="0" value="{{ old('stockkabel') }}" class="form-control" >
                    </div>
                </div>
