  ...
  <main class="main">
    ...
    <section id="about" class="about section">
      ...
      <div class="container">
        ...
        <!-- Laptop Section -->
    <section id="laptop" class="section laptop light-background" data-builder="section">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
            ...
            <div class="content px-xl-5" data-aos="fade-up" data-aos-delay="100">
              <h3><span>“The XPS 14 is back and better than ever.” - @zdnet_official</strong></h3>
            <p> XPS 14 reflects our renewed focus on thoughtful design and real world performance. From a refined chassis to efficiency driven hardware choices, ZDNet highlights why this generation represents a true return to form.</p>
            <p>Link in bio.</p>
            </div>
          ...
          <div class="col-lg-5 order-1 order-lg-2 why-us-img">
            <img src="assets/img/laptop.jpg" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
          </div>
        </div>
