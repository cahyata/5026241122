        ...
        <div class="card-body">
            <form action="{{ route('siswa.store') }}" method="POST" onsubmit="return validasiForm()">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="NRP" id="NRP" maxlength="10" value="{{ old('NRP') }}" class="form-control" >
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Nama" id="Nama" maxlength="20" value="{{ old('Nama') }}" class="form-control" >
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Kelas" id="Kelas" maxlength="5" value="{{ old('Kelas') }}" class="form-control" >
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" name="TanggalLahir" id="TanggalLahir" value="{{ old('TanggalLahir') }}" class="form-control" >
                    </div>
                </div>
